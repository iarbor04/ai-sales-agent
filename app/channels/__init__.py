...
TOKEN_HINTS = (
    ...
    # aiogram отвергает формат ещё до обращения к Telegram: «Token is invalid!»
    ("token is invalid", "это не похоже на токен: он выглядит как 1234567890:AAH... "
                         "Скопируйте строку целиком из сообщения @BotFather"),
